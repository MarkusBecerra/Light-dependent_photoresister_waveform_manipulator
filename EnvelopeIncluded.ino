...
struct EnvelopeADSR
{
  ...
  double GetAmplitude(double mTime)
  {
    double Amplitude = 0.0;
    double LifeTime = mTime - TriggerOnTime;
  ...
  void NoteOn(double mTimeOn)
  {
    TriggerOnTime = mTimeOn;
    NoteOn = true;
  }

  void NoteOff(double mTimeOff)
  {
    TriggerOffTime = mTimeOff;
    NoteOff = false;
  }
